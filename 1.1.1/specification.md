...
**9. Max live buffers per thread param:** `MAX_LIVE_BUFFERS`
- Available values: `[128, 1024, 4096, 8192, 16384, 32768, 65536]`. 
- Note: the heap allocations skipped `65536`, as the pooled allocator started throwing heap OOM when `MAX_LIVE_BUFFERS` reached `65536`.

**10. Switch:** `enableReadWrite`
- Enable read and write on each buffer, to simulate the real-world usage scenario.
